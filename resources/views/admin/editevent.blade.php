...
<div class="container-fluid mt--7">
    ...
    <div class="row col-md-12">
        <div id="inputs-component" class="tab-pane tab-example-result fade show active col-md-12" role="tabpanel"
            ...
            <form method="POST" action="{{route('updateEvent',['event_id'=>$event->id])}}"
                enctype="multipart/form-data">
                @csrf

                @include('includes.actionMessage')

                <div class="text-center event-avatar-click cursor-pointer" style="background: #f4f4f4;
                        border-radius: 10px;
                        font-size: 25px;
                        display: flex;
                        ...
                        margin-bottom: 20px;">
                    <img src="{{($event->event_avatar)?asset('img/userImages/'.$event->event_avatar):asset('img/avatar.png')}}" alt="" width="200px;" height="150px;"
                        id='actual-image-event' class="cursor-pointer">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" id='event-start-date' name="event-start-date"
                                    placeholder="Select date" type="text" value="{{$event->start_date}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Select date" type="text" id='event-end-date'
                                    name="event-end-date" value="{{$event->end_date}}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                placeholder="Event Vanue Name" name="venue_name" value="{{$event->venue_name}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <select class="form-control" name="client">
                                ...
                                <option value="{{$event->client->id}}" selected>{{$event->client->name}}</option>
