...
<div class="container-fluid mt--7">
    ...
    <div class="row col-md-12">
        ...
        <form class="col-md-8" style="margin: 0 auto;" method="POST" action="{{route('storeManager')}}"
            ...
            <button type="submit" class="btn btn-primary btn-lg btn-block">Add Manager</button>
        </form>
    </div>
    @section('body-script')
    <script>
        $(document).ready(function() {
            $( ".view-page-name" ).html( "Create Client" );
        });
    </script>
    @endsection
    @endsection